  ...
  return (
    ...
    <div className='projects-software-container'>
        ...
        <div className='projects-software-description'>
            <span className='projects-software-description-title'>Software Projects</span>
            <div className='projects-software-content'>
            <ImageCarousel images={images} width="500px"/>
            <div className='projects-software-text'>
                <span className='projects-software-text1'>With little pool access due to the COVID pandemic, we made the decision to shift our focus to developing our simulation environment. Simulation provides us with a cheaper and safer way to test our AUV, as well as ample synthetic data. To collect ample synthetic data for use in future design decisions, we decided to delevop two simulations. One to emulate what our robot's onboard cameras see and another to simulate our robot's dynamics. You can learn more about each of these simulations below:</span>
                <button className='projects-software-button1'>
                    <FontAwesomeIcon icon={faEye} style={{ marginRight: '0.5rem' }} />
                    Computer Vision
                </button>
                <button className='projects-software-button1'>
                    <FontAwesomeIcon icon={faDharmachakra} style={{ marginRight: '0.5rem' }} />
                    Control System
                </button>
            </div>
            </div>
