  ...
  return (
    <div className='projects-mechanical-container'>
     ...
     <div className='projects-software-description'>
                <span className='projects-software-description-title'>Mechanical Projects</span>
                <div className='projects-software-content'>
                <ImageCarousel images={images} width="500px"/>
                <div className='projects-software-text'>
                    <span className='projects-software-text1'>With access to in-person workspaces limited during the COVID-era, we have focused primarily on CAD design, and on figuring out manufacturing techniques for said designs once in-person work is allowed again. The mechanical team is divided into three sub-teams, represented by the buttons below. Feel free to click on each one to see what they've been working on.</span>
                    ...
                    <button className='projects-software-button1'>
                        <FontAwesomeIcon icon={faTools} style={{ marginRight: '0.5rem' }} />
                        Actuators
                    </button>
                    <button className='projects-software-button1'>
