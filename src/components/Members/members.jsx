  ...
  return (
    <div className='members-container'>
        <div className='members-title'>
            <img src="/images/members/team_photo_2024.jpg" alt="group" className="group"/>
            <span className='member-title1'>MEET THE TEAM</span>
            <span className='member-title2'>United by curiosity and driven by purpose, our 44+ team members bring unique skills and shared passion to every step of the journey!</span>
            ...
            <div className='members'>
              <div className='admin'>
                ...
                <FontAwesomeIcon icon={faBriefcase} style={{ fontSize: '3.5rem', color:'rgb(9, 7, 69)', marginLeft:'0.5rem' }} />
                </div>
                <div className='align'>
              ...
              <div className='align1'>
                ...
                <FontAwesomeIcon icon={faTools} style={{ fontSize: '3rem', color:'rgb(9, 7, 69)', marginLeft:'0.5rem' }} />
                </div>
                <div className='align'>
              ...
              <div className='align1'>
                ...
                <FontAwesomeIcon icon={faCarBattery} style={{ fontSize: '3rem', color:'rgb(9, 7, 69)', marginLeft:'0.5rem' }} />
                </div>
                <div className='align'>
              ...
              <div className='align1'>
                ...
                <FontAwesomeIcon icon={faCode} style={{ fontSize: '3rem', color:'rgb(9, 7, 69)', marginLeft:'0.5rem' }} />
                </div>
                <div className='align'>
